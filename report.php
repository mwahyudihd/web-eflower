...
$sum = mysqli_query($connection, "SELECT SUM(qty_pembelian) AS totally FROM kwitansi WHERE id_toko = '$id_data' AND status_order = 'LUNAS'");
$array_qty = mysqli_fetch_assoc($sum);
$total_qty = $array_qty['totally'];

$sum2 = mysqli_query($connection, "SELECT SUM(total) AS total_data FROM kwitansi WHERE id_toko = '$id_data' AND status_order = 'LUNAS'");
$array_total = mysqli_fetch_assoc($sum2);
$total_tagihan = $array_total['total_data'];

$sum3 = mysqli_query($connection, "SELECT SUM(total_bersih) AS total_final FROM kwitansi WHERE id_toko = '$id_data' AND status_order = 'LUNAS'");
...
<body>
    <div class="card container">
        <div class="card-header container mb-5">
            <a href="report.php" class="btn btn-warning" id="btn2" disabled="disabled"> Laporan Pesanan Untung </a>
            <span><a href="report-cenceled.php" class="float-end btn btn-secondary" id="btn3" > Laporan Pesanan Batal </a></span>
