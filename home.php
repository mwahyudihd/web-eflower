                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-3">
                            ...
                            <div class="card-body bg-blur">
                                ...
                                <p class="card-text">
                                    Tanaman unik ini bisa dengan mudah ditanam di dalam maupun
                                    di luar ruangan.
                                </p>
                                <a href="#" class="badge bg-success non-deco"><i class="fas fa-tags"></i> Category</a>
                            </div>
                            <div class="card-footer bg-ktg-leaf">
                                <form action="">
                                    <div class="input-group">
                                        <input type="number" name="" id="" class="form-control" pattern="[0-9]" />
                    ...
                    <div class="col-md-6">
                        <div class="card mb-3">
                            <img src="https://placeholder.co/100x70" alt="" class="card-img-top" />
                            <div class="card-body bg-blur">
                                <h5 class="card-title">Lidah mertua</h5>
                                <p class="card-text"><strong>Rp 75.000,-</strong></p>
                                <p class="card-text">
                                    Tanaman lidah mertua akan memperbaiki sistem pemanasan,
                                    ventilasi ruang.
                                </p>
                                <a href="#" class="badge bg-success non-deco"><i class="fas fa-tags"></i> Category</a>
                            </div>
