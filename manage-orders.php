...
$query_data = "SELECT * FROM pembayaran JOIN cart ON pembayaran.no_pembayaran = cart.orderid WHERE id_user_toko = '$current_id'";
										...
										<tr class="card-body">
											...
											<td>
												<a class="btn btn-primary" href="detail-order-manage.php?orderid=<?= $set_data['no_pembayaran']; ?>"
													><i class="fas fa-circle-info"> <?= $set_data['no_pembayaran']; ?></i></a
												>
											</td>
                                            ...
                                            <td><?php if($set_data['status'] == 'menunggu konfirmasi'){ ?>
