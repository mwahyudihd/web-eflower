...
$query = "SELECT * FROM produk JOIN users ON produk.id_pemilik = users.id_user WHERE produk.status = 'aktif' AND produk.id_pemilik != '$sesi_id' ORDER BY produk.harga DESC";
