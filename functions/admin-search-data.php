...
if(isset($_POST['data-req'])){
    ...
    $query = "SELECT * FROM produk JOIN users ON produk.id_user = users.id_user WHERE produk.nama_produk LIKE '%$requestData%' OR users.kota LIKE '%$requestData%' OR users.nama_user = '%$requestData%'";
