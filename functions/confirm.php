...
$query = "INSERT INTO konfirmasi VALUES ('$id_konfirmasi', '$kode_transaksi', '$current_id', '$payment_method', '$payyer', '$tgl_bayar', '$current_date', '$produkid', '$targetFilePath', '$note', '$id_pemilik_produk')";
